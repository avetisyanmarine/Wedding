    ...
    <div className="mx-auto w-full max-w-3xl box-border overflow-hidden backdrop-blur-md rounded-2xl shadow-xl border-2 border-white/30 p-6 sm:p-8">
      ...
      >
        ...
        <div className="group">
          <label
            htmlFor="fullName"
            className="block text-xs sm:text-sm font-semibold text-gray-800 mb-2 sm:mb-3"
          >
            <span className="flex items-center gap-2">
              <h4 className="text-lg">Անուն Ազգանուն*</h4>
            </span>
          </label>
          <input
            type="text"
        ...
        <div className="group">
          <label className="block text-xs sm:text-sm font-semibold text-gray-800 mb-3 sm:mb-4">
            <span className="flex items-center gap-2">
              <h4 className="text-lg">Ո՞ր կողմից եք բարեկամ*</h4>
            </span>
          </label>
        ...
        <div className="group">
          <label className="block text-xs sm:text-sm font-semibold text-gray-800 mb-3 sm:mb-4">
            <span className="flex items-center gap-2">
              <h4 className="text-lg">Մասնակցու՞մ եք*</h4>
            </span>
          </label>
          <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4">
            {[
        ...
        {formData.attending === true && (
          <div className="group animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            >
              <span className="flex items-center gap-2">
                <h4 className="text-lg">Հյուրերի քանակ*</h4>
              </span>
            </label>
        ...
        <div className="group">
          ...
          >
            <span className="flex items-center gap-2">
              ...
              <h4 className="text-lg">Մեկնաբանություն (ընտրովի)</h4>
            </span>
          </label>
          <textarea
            id="comment"
            ...
            rows="3"
            className="w-full px-3 sm:px-4 md:px-5 py-2.5 sm:py-3 md:py-3.5 text-sm sm:text-base text-gray-800 placeholder-gray-400 bg-white border-2 border-gray-200 rounded-lg sm:rounded-xl transition-all duration-300 focus:outline-none focus:border-gray-800 focus:ring-4 focus:ring-gray-100 resize-none group-hover:border-gray-300"
          />
        </div>
